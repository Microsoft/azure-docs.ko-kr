...
description: 보안 감사를 사용 하 여의 분석 및 경고에 대한 이벤트 로깅을 중앙 집중화 하는 방법에 대해 알아봅니다 Azure AD Domain Services
