...
* Azure AD 테넌트.
* [MyPolicies 테넌트](https://mypolicies.com/index.html#section10)입니다.
...
5. **관리자 자격 증명** 섹션 아래에 있는 **테넌트 URL** 에 `https://<myPoliciesCustomDomain>.mypolicies.com/scim`을 입력 합니다. 여기서 `<myPoliciesCustomDomain>`은 myPolicies 사용자 지정 도메인입니다. URL에서 myPolicies customer 도메인을 검색할 수 있습니다.
