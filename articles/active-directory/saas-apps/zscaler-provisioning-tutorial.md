...
5. **관리자 자격 증명** 섹션 아래에서 6 단계에 설명 된 대로 **테넌트 URL** 및 Zscaler 계정의 **암호 토큰** 을 입력 합니다.

6. **테넌트 URL** 및 **암호 토큰**을 가져오려면 Zscaler 포털 사용자 인터페이스에서 **관리 > 인증 설정** 으로 이동 하 고 **인증 유형**아래에서 **SAML** 을 클릭 합니다.
