...
애플리케이션 코드는 외부 서비스를 노출하는 인터넷 액세스 엔드포인트에 아웃바운드 네트워크를 연결하는 데 TCP/IP 및 UDP 기반 프로토콜을 사용할 수 있습니다. 앱은 이러한 동일한 프로토콜을 사용 하 여 Azure 내에서 서비스에 연결할 수 있습니다. 예를 들어 SQL Database에 대한 HTTPS 연결을 설정할 수 있습니다.
