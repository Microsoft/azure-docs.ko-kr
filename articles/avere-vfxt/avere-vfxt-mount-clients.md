...
클러스터가 Blob storage를 사용 하 여 만들어진 경우에는 해당 컨테이너에 대한 네임 스페이스 경로가 `/msazure`
...
클라이언트를 탑재 한 후에는이를 사용 하 여 클러스터의 새 Blob storage 컨테이너에 데이터를 복사할 수 있습니다. 새 저장소를 채우지 않아도 되는 경우 다른 설치 작업에 대한 자세한 내용은 다음 링크를 참조 하세요.
