...
Azure Maps는 래스터 타일 및 벡터 타일을 모두 사용하여 맵을 만듭니다. 가장 낮은 해상도에서 전체 세계는 단일 타일에 적합 합니다. 가장 높은 해상도에서 단일 타일은 38 평방 미터를 나타냅니다. 확대할 때 대륙, 지역, 도시 및 개별 거리에 대한 자세한 내용을 볼 수 있습니다. 타일에 대한 자세한 내용은 [확대/축소 수준 및 타일 그리드](zoom-levels-and-tile-grid.md)를 참조 하세요.
