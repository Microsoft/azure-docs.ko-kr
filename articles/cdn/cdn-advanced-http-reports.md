...
* 상위 도시 보고서에 대한 도구 설명에 도시 이름, 시/도 및 국가/지역 약어를 식별합니다.
...
그래프의 왼쪽(Y축)은 지정된 날짜에 발생한 적중 수를 나타냅니다. 직접 그래프 아래 (x 축)에서 날짜를 나타내는 레이블을 찾을 수 있습니다 (형식: YYYY-MM-DD) 보고서에 포함 된 각 날짜에 대한 합니다.
...
그래프의 왼쪽(Y축)은 지정된 시간에 발생한 적중 수를 나타냅니다. 직접 그래프 아래 (x 축)에서 날짜/시간을 나타내는 레이블을 찾을 수 있습니다 (형식: YYYY-MM-DD hh: mm) 보고서에 포함 된 각 시간에 대한 합니다. 시간은 24시간 형식을 사용하여 보고되며 UTC/GMT 표준 시간대를 사용하여 지정됩니다.
...
그래프의 왼쪽(Y축)은 특정 일에 발생한 자산에 대한 총 요청 수를 나타냅니다. 직접 그래프 아래 (x 축)에서 날짜를 나타내는 레이블을 찾을 수 있습니다 (형식: YYYY-MM-DD)는 CDN에 대한 요청 된 자산에 대한 보고 되었습니다.
