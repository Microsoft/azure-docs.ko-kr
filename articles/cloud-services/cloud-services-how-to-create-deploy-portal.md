...
> [!NOTE]
> Azure DevOps에서 클라우드 서비스를 게시하려는 경우 빠른 생성을 사용한 다음 Azure 빠른 시작 또는 대시보드에서 Azure DevOps 게시를 설정합니다. 자세한 내용은 [Azure DevOps를 사용 하 여 azure에 지속적인 전송][TFSTutorialForCloudService]을 참조 하거나 **빠른 시작** 페이지에 대한 도움말을 참조 하세요.
>
>
