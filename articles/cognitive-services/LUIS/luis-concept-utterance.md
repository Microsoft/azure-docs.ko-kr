...
앱에서 정규화를 설정 하면 **테스트** 창의 점수, 일괄 처리 테스트 및 엔드포인트 쿼리가 분음 부호 나 문장 부호를 사용 하 여 모든 길이 발언에 대해 변경 됩니다.
...
**문장 부호** 표준화는 모델이 학습 되 고 엔드포인트 쿼리가 예측 되기 전에 길이 발언에서 문장 부호가 제거 된다는 것을 의미 합니다. 
