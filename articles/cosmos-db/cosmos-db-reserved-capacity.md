...
Azure Cosmos DB 예약 된 용량을 사용 하면 1 년 또는 3 년 동안 Azure Cosmos DB 리소스에 대한 예약을 커밋하여 비용을 절감할 수 있습니다. Azure Cosmos DB 예약 용량을 사용하여 Cosmos DB 리소스에 대 해 프로비전된 처리량에 할인을 받을 수 있습니다. 리소스의 예로 데이터베이스 및 컨테이너(테이블, 컬렉션 및 그래프)를 들 수 있습니다.
...
* 종 량 제 요금은 하나 이상의 Enterprise 또는 개별 구독에 대한 소유자 역할에 속해야 합니다.  
...
4. 아래 표에서 설명한 대로 필요한 필드를 채웁니다.
   ...
   |조건  |   1년 또는 3년입니다.   |
   |처리량 유형   |  처리량은 요청 단위로 프로 비전 됩니다. 두 가지 모두에 대해 프로 비전 된 처리량에 대한 예약을 구입할 수 있습니다. 여러 지역 쓰기 처리량 형식에는 두 개의 값을 선택할 수 있습니다. 100 r u/시간/시간 및 100 다중 마스터/시간/초|
