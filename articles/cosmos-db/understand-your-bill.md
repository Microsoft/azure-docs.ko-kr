...
> [!NOTE]
> 요금 청구는 60 분이 아닌 벽 시계 시간의 일부에 대한 것입니다.
...
| | |2 개의 추가 지역에 대한 처리량 청구서: 미국 동부, 유럽 북부 (모든 지역에서 쓰기 가능)  |`(2 + 1) * (60 K RU/sec /100 * $0.016) * 100 hours = $2,880`  |$2,880  |
...
| | |2 개의 추가 지역에 대한 처리량 청구서: 미국 동부, 유럽 북부 (모든 지역에서 쓰기 가능)  |`(2 + 1) * (120 K RU/sec /100 * $0.016) * 100 hours = $5,760`  |$5,760  |
...
| | |2 개의 추가 지역에 대한 처리량 청구서: 미국 동부, 유럽 북부 (모든 지역에서 쓰기 가능)  |`(2 + 1) * (140 K RU/sec /100 * $0.016-) * 100 hours = $6,720` |$6,720 |
...
| | |2 개의 추가 지역에 대한 처리량 청구서: 미국 동부, 유럽 북부 (모든 지역에서 쓰기 가능)  |`(1 + 1) * (90 K RU/sec /100 * $0.016) * 100 hours = $2,880`  |$2,880  |
...
| | |2 개의 추가 지역에 대한 처리량 청구서: 미국 동부, 유럽 북부 (모든 지역에서 쓰기 가능)  |`(1 + 1) * (40 K RU/sec /100 * $0.016) * 100 hours = $1,280`  |$1,280  |
...
| | |2 개의 추가 지역에 대한 처리량 청구서: 미국 동부, 유럽 북부 (모든 지역에서 쓰기 가능)  |`(1 + 1) * (120 K RU/sec /100 * $0.016) * 200 hours = $1,280`  |$7,680  |
...
| | |2 개의 추가 지역에 대한 처리량 청구서: 미국 동부, 유럽 북부 (모든 지역에서 쓰기 가능)  |`(1 + 1) * (70 K RU/sec /100 * $0.016) * 20 hours = $448`  |$224  |
|| |**월간 총 비용**  | |**$38,688**   |
...
총 r u/초: 500 + 400 = 900 시간당 비용: 900/100 * $0.008 = $0.072 처리량에 대한 월별 비용 예상 (31 일 가정): $0.072 * 24 * 31 = $53.57
