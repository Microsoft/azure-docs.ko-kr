...
## <a name="example"></a>예제
이 예제에서 파이프라인의 웹 작업은 REST 엔드포인트을 호출하고 Azure SQL 연결된 서비스 및 Azure SQL 데이터 세트를 엔드포인트에 전달합니다. REST 엔드포인트은 Azure SQL 연결 문자열을 사용하여 Azure SQL Server에 연결하고 SQL Server의 인스턴스 이름을 반환합니다.
