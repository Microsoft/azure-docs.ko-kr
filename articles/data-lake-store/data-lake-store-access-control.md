...
파일이나 폴더를 만들 때는 umask를 사용하여 자식 항목에서 기본 ACL이 설정되는 방식을 수정합니다. umask는 **소유 사용자**, **소유 그룹**및 **기타**에 대한 RWX 값을 포함 하는 부모 폴더의 9 비트 값입니다.

Azure Data Lake Storage Gen1에 대한 umask는 007로 설정 된 상수 값입니다. 이 값은 다음 표와 같이 변환됩니다.
