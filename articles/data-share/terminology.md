...
데이터 소비자가 데이터 공유 초대를 수락 하면 스냅숏을 만들 수 있습니다. 초대를 수락 하면 공유 된 데이터에 대한 전체 스냅숏을 트리거할 수 있습니다. 스냅숏은 데이터 소비자가 스냅숏을 생성 한 시점의 데이터 복사본입니다. 
...
데이터 공급자는 데이터 공유에 대한 스냅숏 설정을 사용 하도록 설정할 수 있습니다. 이 설정을 사용 하면 데이터 소비자가 증분 업데이트를 발생 시킬 때 받을 수 있습니다. 데이터 공급자가 공유 된 데이터에 대한 업데이트를 수신 하는 경우이 설정을 사용 하도록 설정 해야 합니다. 
...
받는 사람은 데이터 공유에 대한 초대를 받는 사람입니다. 일반적으로 데이터 공급자는 만든 데이터 공유에 받는 사람을 추가 합니다. 초대를 받는 사람은 초대를 수락 하면 데이터 소비자가 됩니다.  
