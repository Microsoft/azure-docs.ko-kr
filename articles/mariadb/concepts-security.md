...
가상 네트워크 서비스 엔드포인트은 Azure 백본을 통해 가상 네트워크 연결을 확장 합니다. 가상 네트워크 규칙을 사용 하 여 가상 네트워크에서 선택한 서브넷의 연결을 허용 하도록 Azure Database for MariaDB 서버를 설정할 수 있습니다. 자세한 내용은 [가상 네트워크 서비스 엔드포인트 개요](concepts-data-access-security-vnet.md)를 참조 하세요.
