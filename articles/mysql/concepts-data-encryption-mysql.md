...
* Key Vault 및 Azure Database for MySQL는 동일한 Azure Active Directory (Azure AD) 테넌트에 속해야 합니다. 교차 테넌트 Key Vault 및 서버 상호 작용은 지원 되지 않습니다. 나중에 리소스를 이동 하려면 데이터 암호화를 다시 구성 해야 합니다.
