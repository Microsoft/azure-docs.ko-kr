...
|**모든 네트워크 포트는 VM에 연결 된 NSG에서 제한 되어야 합니다.**|기존 허용 규칙의 액세스를 제한 하 여 인터넷 연결 Vm의 네트워크 보안 그룹을 강화 합니다.<br>이 권장 사항은 모든 포트 (22, 3389, 5985, 5986, 80 및 1443 제외)가 *모든* 원본에 대해 열린 경우에 트리거됩니다.<br>(관련 정책: 인터넷 연결 엔드포인트을 통해 액세스를 제한 해야 함)|높음|N|가상 머신|
