...
네트워크는 공격에 취약할 수 있으므로 기존 방어에서 발전 해야 합니다. 공격자는 신뢰할 수 있는 경계 내의 단일 엔드포인트을 손상 시킨 다음 전체 네트워크에서 발판를 신속 하 게 확장할 수 있습니다. [제로 트러스트](https://www.microsoft.com/security/blog/2018/06/14/building-zero-trust-networks-with-microsoft-365/) 네트워크는 경계 내에서 네트워크 위치를 기준으로 신뢰 개념을 제거 합니다. 대신, 제로 신뢰 아키텍처는 장치 및 사용자 신뢰 클레임을 사용 하 여 조직 데이터 및 리소스에 대 한 액세스를 게이트 합니다. 새 이니셔티브의 경우 액세스 시 신뢰의 유효성을 검사 하는 0 신뢰 방식을 채택 합니다.
