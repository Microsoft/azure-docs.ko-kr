---
title: Azure CLI 스크립트 샘플-IPv6 가상 네트워크 엔드포인트 구성-표준 Load Balancer (미리 보기)
titlesuffix: Azure Virtual Network
description: Azure Virtual Network에서 Azure CLI를 사용 하 여 IPv6 엔드포인트 사용
...
---
# <a name="configure-ipv6-endpoints-in-virtual-network-script-sample-using-standard-load-balancerpreview"></a>표준 Load Balancer를 사용 하 여 가상 네트워크 스크립트 샘플에서 IPv6 엔드포인트 구성 (미리 보기)
