---
title: Azure CLI 스크립트 샘플-IPv6 가상 네트워크 엔드포인트 구성 (미리 보기)
...
---
# <a name="configure-ipv6-endpoints-in-virtual-network-script-sample-preview"></a>Virtual network 스크립트 샘플에서 IPv6 엔드포인트 구성 (미리 보기)
