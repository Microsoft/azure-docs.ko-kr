...
1. **저장**을 선택합니다.
1. **사용 권한 부여**를 선택한 다음, **예**를 선택합니다. 권한이 완전히 부여 될 때까지 몇 분 정도 걸릴 수 있습니다.
...
1. **애플리케이션 권한**을 선택합니다.
1. **디렉터리** 를 확장 하고 **디렉터리. ReadWrite. 모두** 확인란을 선택 합니다.
1. **권한 추가**를 선택 합니다. 지시에 따라 몇 분 정도 기다린 후 다음 단계를 진행 합니다.
1. **사용자의 테넌트 이름에 대해 관리자 동의 부여를**선택 합니다.
1. 테넌트 관리자 계정을 선택 합니다.
1. **수락**을 선택합니다.
1. **새로 고침**을 선택 하 고 "다음에 대해 권한 부여 ..."를 확인 합니다. **상태**아래에 나타납니다. 권한이 완전히 부여 될 때까지 몇 분 정도 걸릴 수 있습니다.