...
- 끌어서를 사용 하 여 데이터를 복사 하 고 파일 탐색기를 사용 하 여 또는 명령줄을 통해 삭제할 수 있습니다. 복사할 파일의 집계 크기가 10GB 보다 큰 경우에 Robocopy 등 rsync 대량 복사 프로그램을 사용 하는 것이 좋습니다. 대량 복사 도구는 일시적인 오류에 대한 복사 작업을 다시 시도 및 추가적인 복원 력을 제공 합니다.
