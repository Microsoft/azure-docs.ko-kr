...
=======
Azure CloudShell을 사용 하는 경우 사용자 계정에 자동으로 연결 되며 AzAccount 명령을 실행할 필요가 없습니다. PowerShell을 로컬로 실행 하는 경우 상승 된 권한으로 PowerShell 콘솔을 열고 `Connect-AzAccount` 명령을 사용 하 여 Azure에 연결 합니다.
